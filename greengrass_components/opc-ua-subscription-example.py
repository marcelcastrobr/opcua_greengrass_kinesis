...
STREAM_NAME_REAL = "<<name of stream for real time data>>"
STREAM_NAME_ALL = "<<name of stream for all data>>"
KNS_NAME = "<<name of Kinesis data stream>>"
...
def run_writing():
    ...
    try:
        client = Client("opc.tcp://10.0.143.208:62541") #Client("opc.tcp://10.163.224.24:49320")
        client.connect()
    ...
    bucket_name = "<<name of the S3 bucket where the tag config is stored" 
    key_name = "opcua/tags/demo_tags.csv"
